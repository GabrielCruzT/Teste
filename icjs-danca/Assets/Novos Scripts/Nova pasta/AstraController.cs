...
[System.Serializable]
public class DepthFrameEvent : UnityEvent<DepthFrame> { }

[System.Serializable]
public class ColorFrameEvent : UnityEvent<ColorFrame> { }

[System.Serializable]
public class BodyFrameEvent : UnityEvent<BodyStream, BodyFrame> { }

[System.Serializable]
public class MaskedColorFrameEvent : UnityEvent<MaskedColorFrame> { }

[System.Serializable]
public class ColorizedBodyFrameEvent : UnityEvent<ColorizedBodyFrame> { }

[System.Serializable]
public class BodyMaskEvent : UnityEvent<BodyMask> { }
...
public class AstraController : MonoBehaviour
{
    ...
    public DepthFrameEvent NewDepthFrameEvent = new DepthFrameEvent();
    public ColorFrameEvent NewColorFrameEvent = new ColorFrameEvent();
    public BodyFrameEvent NewBodyFrameEvent = new BodyFrameEvent();
    public MaskedColorFrameEvent NewMaskedColorFrameEvent = new MaskedColorFrameEvent();
    public ColorizedBodyFrameEvent NewColorizedBodyFrameEvent = new ColorizedBodyFrameEvent();
    public BodyMaskEvent NewBodyMaskEvent = new BodyMaskEvent();
    ...
    private void OnAstraInitializing(object sender, AstraInitializingEventArgs e)
    {
        ...
        Astra.BodyTracking.SetLicense("oJ2yhcJmF7DNYxes5BFZd40QmU919j4ftTlEj71pp3u0pLz44flgzpbU1yFCuOCsgFBXq0LSSj+Hg+fxQlkBDU5hbWU9T1JCQkVDfE9yZz1PcmJiZWN8Q29tbWVudD17Y29tbWVudDosY3VzdG9tZXJfdHlwZTpvcmRpbmFyeSxsaWNlbnNlX3R5cGU6b2ZmbGluZSx2ZXJzaW9uOjF9fEV4cGlyYXRpb249MTU5MDg4OTU2MA==");
